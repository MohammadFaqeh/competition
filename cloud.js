...
window.CloudCompetition=(()=>{
  ...
  return {enabled,init,signInAdmin,signInCommittee,refreshCommitteeAccess,signOut,loadCompetitionState,saveCompetitionState,queueStateSave,listCommittees,saveCommittee,setCommitteeActive,setCommitteeFinalEdit,listFinalEditAudit,deleteParticipantSession,listSessions,claimStudent,saveSession,queueSessionSave,log,get context(){return context},get client(){return client}};
})();
