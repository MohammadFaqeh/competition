...
window.CloudCompetition=(()=>{
  ...
  return {enabled,init,signInAdmin,signInCommittee,signInSubAdmin,resumeSubAdmin,refreshCommitteeAccess,signOut,loadCompetitionState,saveCompetitionState,queueStateSave,markAdminKnownIds,listCommittees,saveCommittee,assignParticipantToCommittee,transferParticipant,setCommitteeActive,deleteCommittee,setCommitteeFinalEdit,listFinalEditAudit,deleteParticipantSession,listSessions,claimStudent,createCommitteeDraw,createAdminDraw,replaceCommitteePosition,saveSession,queueSessionSave,log,listSubAdmins,saveSubAdmin,deleteSubAdmin,saveSubAdminParticipants,queueSubAdminParticipantsSave,markSubAdminKnownIds,createSubAdminDraw,listActivityLog,get context(){return context},get client(){return client}};
})();
