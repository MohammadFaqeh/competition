...
window.CloudCompetition=(()=>{
  ...
  return {enabled,init,signInAdmin,signInCommittee,signOut,loadCompetitionState,saveCompetitionState,queueStateSave,listCommittees,saveCommittee,setCommitteeActive,deleteParticipantSession,listSessions,claimStudent,saveSession,queueSessionSave,log,get context(){return context},get client(){return client}};
})();
