...
function renderCommitteePassRate(committee){
  ...
  // بناءً على طلب صريح: هذه البطاقة (عدد ممتحَنين/ناجحين/راسبين ونسبة إجمالية) تبقى ظاهرة
  // للجنة دائماً، حتى لو كانت الإدارة مفعّلة إعداد "إخفاء العلامة عن اللجنة" — ذاك الإعداد يبقى
  // يحجب العلامة الفردية الدقيقة لكل متسابق فقط (بقائمة المتسابقين وشاشة "نتيجة معتمدة")، لا
  // الإحصائية المجمَّعة هون.
